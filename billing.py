from tkinter import * #Tkinter is used to python binding to the GUI toolkit.
import math,random,os
from tkinter import messagebox
import sys  # provides information about constants
import tempfile  #TemporaryFile() function

values = {}
class Bill_App:
    def __init__(self,root):# To initialize tkinter 
          self.root=root
          ...
          F5.place(x=1075,y=180,width=400,height=380)
          ...
          m1_label=Label(F6,text="Total Cosmetic Price:",font=("times new roman",14,"bold")).grid(row=0,column=0,padx=30,pady=1,sticky="w")
          ...
          m2_label=Label(F6,text="Total Grocery Price:",font=("times new roman",14,"bold")).grid(row=1,column=0,padx=30,pady=1,sticky="w")
          ...
          m3_label=Label(F6,text="Total Cold Drinks Price:",font=("times new roman",14,"bold")).grid(row=2,column=0,padx=30,pady=1,sticky="w")
          ...
          btn_frame.place(x=840,width=670,height=190)
          


          total_button=Button(btn_frame,command=self.total,text="Total",bg="lightblue",fg="white",bd=2,pady=15,width=12,font="arial 15 bold").grid(row=0,column=0,padx=5,pady=5)
          
          

          gerenate_bill_button=Button(btn_frame,command=self.bill_area,text="Generate Bill",bg="lightblue",fg="white",bd=2,pady=15,width=12,font="arial 15 bold").grid(row=0,column=1,padx=5,pady=5)
          clear_button=Button(btn_frame,text="Clear",command=self.clear_data,bg="lightblue",fg="white",bd=2,pady=15,width=12,font="arial 15 bold").grid(row=1,column=1,padx=5,pady=5)
          

          save_bill_button=Button(btn_frame,text="Save",command=self.save_bill,bg="lightblue",fg="white",bd=2,pady=15,width=12,font="arial 15 bold").grid(row=0,column=2,padx=5,pady=5)
          exit_button=Button(btn_frame,text="Exit",command=self.exit_app,bg="lightblue",fg="white",bd=2,pady=15,width=12,font="arial 15 bold").grid(row=1,column=2,padx=5,pady=5)

          print_button=Button(btn_frame,command=self.iprint,text="Print",bg="lightblue",fg="white",bd=2,pady=15,width=12,font="arial 15 bold").grid(row=0,column=3,padx=5,pady=5)
          self.welcome_bill()
    ...
    def save_bill(self):
        ...
        if op>0:
            ...
            op=messagebox.showinfo("Saved",f"Bill No:{self.bill_number} saved successfully")
            f1.close()
